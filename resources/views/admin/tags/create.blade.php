...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <form class="laravelForm"action="{{ route('admin.tags.store') }}" method="POST">
                @csrf
                <div class="form-group">
                    <label for="name">Nombre</label>
                    <input type="text" name="name" class="form-control name" autocomplete="off" placeholder="Ingrese el nombre de la etiqueta">
                    <span class="text-danger error-name"></span>
                </div>
                <div class="form-group">
                    <label for="slug">Slug</label>
                    <input type="text" name="slug" class="form-control slug" placeholder="Ingrese el slug de la etiqueta" readonly>
